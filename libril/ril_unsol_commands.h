...
*/
    ...
    /* SAMSUNG */
    {RIL_UNSOL_STK_SEND_SMS_RESULT, responseVoid, DONT_WAKE},
    {RIL_UNSOL_DEVICE_READY_NOTI, responseVoid, DONT_WAKE},
    {RIL_UNSOL_STK_CALL_CONTROL_RESULT, responseVoid, DONT_WAKE},
    {RIL_UNSOL_AM, responseVoid, DONT_WAKE},
    {RIL_UNSOL_WB_AMR_STATE, responseVoid, DONT_WAKE},
    {RIL_UNSOL_IPV6_ADDR, responseVoid, DONT_WAKE},
