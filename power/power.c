...
{
    sysfs_write("/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq", on ? "1400000" : "500000");

    //FIXME: add GPU interface to the kernel and add battery optimized settings
}
